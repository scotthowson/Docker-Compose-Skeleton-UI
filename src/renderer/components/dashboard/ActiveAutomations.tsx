    ...
    return (
      <div className="glass-card p-4 md:p-6 animate-fade-in opacity-60">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-600">Automations</h3>
        </div>
        ...
        <div onClick={() => setCurrentPage('automations')}>
          {recent.length === 0 ? (
            ...
            <div className="space-y-1.5">
              {recent.map((a) => (
                <div key={a.id} className="flex items-center justify-between rounded-lg bg-white/[0.03] border border-white/[0.04] px-2.5 py-1.5">
