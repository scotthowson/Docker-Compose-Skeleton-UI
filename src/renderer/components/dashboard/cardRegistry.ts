...
export const CARD_REGISTRY: CardRegistryEntry[] = [
  ...
  { id: 'health-summary',     title: 'Health Monitor',    iconName: 'HeartPulse',      defaultX: 0,  defaultY: 8,  defaultW: 12, defaultH: 8,  minW: 4, minH: 2, maxW: 24, maxH: 14, description: 'Health score gauge + container status grid' },
  ...
  { id: 'container-overview', title: 'Containers',        iconName: 'Box',             defaultX: 0,  defaultY: 17, defaultW: 8,  defaultH: 8,  minW: 4,  minH: 2, maxW: 24, maxH: 14, description: 'Container status breakdown' },
  { id: 'server-info',        title: 'Server Info',       iconName: 'Server',          defaultX: 8,  defaultY: 17, defaultW: 8,  defaultH: 8,  minW: 4,  minH: 2, maxW: 24, maxH: 14, description: 'System information' },
  { id: 'disk-monitor',       title: 'Disk Monitor',      iconName: 'HardDrive',       defaultX: 16, defaultY: 17, defaultW: 8,  defaultH: 8,  minW: 4,  minH: 2, maxW: 24, maxH: 14, description: 'Disk usage per mount' },
  { id: 'trends',             title: 'Resource Trends',   iconName: 'TrendingUp',      defaultX: 0,  defaultY: 25, defaultW: 6,  defaultH: 3,  minW: 4,  minH: 2, maxW: 24, maxH: 10, description: 'Historical resource graphs' },
  { id: 'top-consumers',      title: 'Top Consumers',     iconName: 'Zap',             defaultX: 6,  defaultY: 25, defaultW: 6,  defaultH: 3,  minW: 4,  minH: 2, maxW: 24, maxH: 10, description: 'Highest resource-using containers' },
  { id: 'image-updates',      title: 'Image Updates',     iconName: 'Download',        defaultX: 12, defaultY: 25, defaultW: 6,  defaultH: 3,  minW: 4,  minH: 2, maxW: 24, maxH: 10, description: 'Available image updates' },
  { id: 'backup-status',      title: 'Backup Status',     iconName: 'Archive',         defaultX: 18, defaultY: 25, defaultW: 6,  defaultH: 3,  minW: 4,  minH: 2, maxW: 24, maxH: 10, description: 'Backup schedule and status' },
  { id: 'log-health',         title: 'Log Health',        iconName: 'FileText',        defaultX: 0,  defaultY: 28, defaultW: 8,  defaultH: 3,  minW: 3,  minH: 2, maxW: 24, maxH: 8,  description: 'Log error/warning counts' },
  { id: 'maintenance',        title: 'Maintenance',       iconName: 'Wrench',          defaultX: 8,  defaultY: 28, defaultW: 8,  defaultH: 3,  minW: 4,  minH: 2, maxW: 24, maxH: 8,  description: 'Docker cleanup status' },
  { id: 'notifications',      title: 'Notifications',     iconName: 'Bell',            defaultX: 16, defaultY: 28, defaultW: 8,  defaultH: 3,  minW: 4,  minH: 2, maxW: 24, maxH: 8,  description: 'Notification delivery status' },
  { id: 'automations',        title: 'Automations',       iconName: 'Zap',             defaultX: 0,  defaultY: 31, defaultW: 8,  defaultH: 7,  minW: 4,  minH: 2, maxW: 24, maxH: 12, description: 'Active automation rules' },
